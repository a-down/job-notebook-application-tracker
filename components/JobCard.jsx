      ...
      <div className="bg-white p-4 rounded-md flex justify-between col-span-1 drop-shadow-brand">
        <div className="justify-between">
          ...
          <div className="flex flex-col gap-1 mb-4">
            ...
            <Link href="https://google.com" target="_blank" className='text-sm text-brand-primary underline hover:opacity-80 leading-none duration-200'>Application Link</Link>
