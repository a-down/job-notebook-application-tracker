  ...
  return (
    <div className={` ${sharedStyle} col-span-3 max-h-[192px] relative`}>
      ...
      {newContactVisibility && (
        <form className="col-span-2 w-full">
          ...
          <div className='flex gap-1 items-center pl-0.5 mb-1 text-gray-7'>
            ...
            <input className='ml-0.5 text-xxs p-1 border border-gray-5 rounded-sm w-full' placeholder='LinkedIn'/>
          </div>
      ...
      {!newContactVisibility && contacts && (
        ...
        <div className=' mt-2 contact-wrapper grid grid-cols-2 gap-x-1 gap-y-2 overflow-scroll'>
