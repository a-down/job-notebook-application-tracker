      ...
      <main className='mx-4 md:mx-auto py-8 md:py-12 md:max-w-[60vw] xl:max-w-[800px] h-40 flex flex-col gap-8'>
        ...
        <div className=' flex flex-col gap-4'>
          ...
          <p className='leading-relaxed'>{`If you have any issues with your Job Notebook, please create an issue at `} 
            <a href="https://github.com/a-down/job-notebook-application-tracker/issues" className=' underline hover:text-brand-primary'>github.com/a-down/job-notebook-application-tracker/issues</a>.
          </p>
          
          <p className='leading-relaxed'>{`For questions or conversations, reach out on LinkedIn at `} 
            <a href="https://linkedin.com/in/alec-downing/" className=' underline hover:text-brand-primary'>/in/alec-downing/</a>.
          </p>

          <p className='leading-relaxed'>{`You can find more details about the project at `} 
            <a href="https://github.com/a-down/job-notebook-application-tracker" className=' underline hover:text-brand-primary'>https://github.com/a-down/job-notebook-application-tracker</a>.
          </p>
        </div>
